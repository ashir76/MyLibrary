...
// MyLibrary
#define COCOAPODS_POD_AVAILABLE_MyLibrary
#define COCOAPODS_VERSION_MAJOR_MyLibrary 0
#define COCOAPODS_VERSION_MINOR_MyLibrary 1
#define COCOAPODS_VERSION_PATCH_MyLibrary 0
